...
{
    [SerializeField] private float _thumbRotEntry = 10f;
    [SerializeField] private float _thumbRotExit = 12f;
    ...
    private void Update()
    {
        ...
        if (Processing)
        {
            ...
            else
            {
                ...
                CalculateContacting(_leapProvider.GetHand(Chirality));
    ...
    protected void CalculateContacting(Hand hand)
    {
        ...
        float angleBoundary = Contacting ? _thumbRotExit : _thumbRotEntry;
